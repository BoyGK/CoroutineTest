...
object RSAUtil {
    ...
    private const val ENCRYPT_MAX_SIZE = 245//加密每次最大加密字节
     ...
     * @param privateKey 私钥
     */
    fun decryptByPrivateKey(byteArray: ByteArray, privateKey: PrivateKey): ByteArray {
        //创建cipher对象
        val cipher = Cipher.getInstance(transformation)
        //初始化cipher
    ...
    fun getPublicKey(keyBytes: ByteArray): PublicKey {
        ...
        val keyFactory: KeyFactory = KeyFactory.getInstance(transformation)
